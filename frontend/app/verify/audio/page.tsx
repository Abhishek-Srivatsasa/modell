...
export default function UploadAnalysisPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="font-display text-xl text-text-primary">Voice Authenticity Analysis</h1>
      <div className="flex gap-3 mb-6">
        <div className={`flex-1 p-4 rounded-lg border-2 border-[#00D4FF] bg-[#00D4FF]/10 text-[#00D4FF]`}>
          <div className="text-2xl mb-1">🎙️</div>
          <div className="font-semibold">Acoustic Spoof Detection</div>
          <div className="text-xs mt-1">AI voice cloning, ElevenLabs, synthetic generation</div>
          <div className="text-xs mt-2 font-mono opacity-70">CNN-BiLSTM • Librosa Spectrograms</div>
        </div>
      </div>
      <div
